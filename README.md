...
El proyecto busca predecir y clasificar el estado académico de los estudiantes (graduado, matriculado o desertor) a partir de variables socioeconómicas, demográficas y de desempeño académico.
...
Para el desarrollo del proyecto se utilizará el dataset público “Predict Students Dropout and Academic Success” disponible en UCI Machine Learning Repository.
